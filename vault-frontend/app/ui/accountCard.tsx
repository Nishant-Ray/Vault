...
export default function AccountCard({ name, id, nickname, isCredit, onRemove, ...rest }: AccountCardProps) {
  ...
  return (
    <Tilt scale={1.04} tiltMaxAngleX={5} tiltMaxAngleY={5} {...rest} className="z-0 w-[20.25rem] h-[12.75rem]">
      ...
      <AccountModal modalType={nicknameModal ? ACCOUNT_NICKNAME_MODAL_TYPE : ACCOUNT_REMOVE_MODAL_TYPE} isOpen={isAccountModalOpen} existingNickname={newNickname} onNicknameSubmit={handleAccountNicknameFormSubmit} onRemove={handleAccountRemove} onClose={handleAccountModalClose}/>
